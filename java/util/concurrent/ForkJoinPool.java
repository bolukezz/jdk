...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    private int lockRunState() {
        ...
        return ((((rs = runState) & RSLOCK) != 0 ||
                !U.compareAndSwapInt(this, RUNSTATE, rs, rs |= RSLOCK)) ? awaitRunStateLock() : rs);
    }
    ...
    static WorkQueue commonSubmitterQueue() {
        ...
        return (p != null && (ws = p.workQueues) != null &&
                (m = ws.length - 1) >= 0) ? ws[m & r & SQMASK] : null;
    }
    ...
    public String toString() {
        ...
        if (ac < 0) // ignore transient negative
            ac = 0;
        int rs = runState;
        String level = ((rs & TERMINATED) != 0
                ? "Terminated"
                : (rs & STOP) != 0 ? "Terminating" : (rs & SHUTDOWN) != 0 ? "Shutting down" : "Running");
    ...
    static final class InnocuousForkJoinWorkerThreadFactory
        ...
        public final ForkJoinWorkerThread newThread(ForkJoinPool pool) {
            return (ForkJoinWorkerThread.InnocuousForkJoinWorkerThread) java.security.AccessController.doPrivileged(
